            ...
            <MainContainer>
                ...
                {view === VIEWS.WORLDWIDE_VIEW ? (
                    <>
                        ...
                        <BoxesWrapper>
                            <div className="box">
                                <BoxPanelHeading color={theme.colors.casesBoxYellow}>{i18n.confirmed}</BoxPanelHeading>
                            ...
                            <div className="box">
                                <BoxPanelHeading color={theme.colors.casesBoxRed}>{i18n.deaths}</BoxPanelHeading>
                                <div className="cases-numbers">
...
export const getServerSideProps = async () => {
    ...
    const fetchCountries = () => {
        return axios
            .get(apiUrl + '/countries', { timeout: timeout })
    ...
    const fetchWorldwide = () => {
        return axios
            .get(apiUrl + '/country?name=Worldwide', { timeout: timeout })
            .then((res: AxiosResponse) => {
    ...
    const fetchArticles = () => {
        return axios
            .get(apiUrl + '/articles', { timeout: timeout })
            .then((res: AxiosResponse) => {
